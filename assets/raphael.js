...
(function(a) {
    var b = "0.3.0",
        ...
        k = function(a, b) {
            ...
            for (r = 0; r < s; r++) {
                m = e[r];
                if ("zIndex" in m) if (m.zIndex == n[f]) {
                    p.push(m.apply(b, d));
                    if (i) return p;
                    do {
    ...
    k.unbind = function(a, b) {
        ...
        for (l = 0, m = k.length; l < m; l++) {
            ...
            while (g.n) {
                if (b) {
                    if (g.f) {
                        for (l = 0, m = g.f.length; l < m; l++) if (g.f[l] == b) {
                            g.f.splice(l, 1);
                            break
                    ...
                    for (h in g.n) if (g.n[c](h) && g.n[h].f) {
                        var o = g.n[h].f;
                        for (l = 0, m = o.length; l < m; l++) if (o[l] == b) {
                            o.splice(l, 1);
                            break
    ...
    function cr(b, d, e, f, h, i) {
        ...
        var j, k, l, m = [],
            ...
            t = {},
            u = {};
        if (f) for (w = 0, x = cl.length; w < x; w++) {
            var v = cl[w];
    ...
    ct.push = function() {
        ...
        for (var c = 0, d = this.items.length; c < d; c++) if (a.call(b, this.items[c]) === !1) return this;
        return this
    };
    ...
    ct.attr = function(b, c) {
        ...
        for (var b = 0, c = this.length, d; b < c; b++) if (d || this[b] == a) this[b] = this[b + 1], d = 1;
        if (d) {
...
function(a) {
    ...
    C.prototype = D, D.constructor = C, a._engine.path = function(a, b) {
        ...
        for (var m in this.paper.customAttributes) if (this.paper.customAttributes[b](m) && l[b](m) && a.is(this.paper.customAttributes[m], "function")) {
